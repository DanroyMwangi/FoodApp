...
<body>
    <div class="overflow-hidden">
        ...
        <div class="main w-full h-screen m-auto flex justify-center text-center items-center">
            <div class="w-1/2">
                <h3 class="text-7xl">
                    Fast Food Restaurants<sup>©</sup>
                </h3>

                <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa voluptatibus, ullam dolorem dicta deserunt recusandae tenetur modi, accusantium reiciendis cumque corrupti magni, repudiandae facilis similique. Incidunt et corrupti totam ex. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis, voluptate! Nemo nisi cupiditate perspiciatis, quibusdam, fuga amet consequatur mollitia harum corporis dolorum nam quas quae illo pariatur fugiat ut? Debitis! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Totam fugit maiores unde tenetur quia voluptatum vero saepe dolor molestiae quos explicabo harum, deserunt exercitationem numquam sunt nemo voluptatem non! Quas. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit fugit, voluptatem obcaecati doloribus incidunt delectus repudiandae fugiat reprehenderit, voluptatum dolor, veniam nihil eaque quidem. Veritatis consequatur non fugit porro deleniti.
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt et odit sed natus, dolores tempora quia ex possimus distinctio eligendi fugit corporis. Temporibus aspernatur dolorem consequatur id neque! Consequatur, veniam!
                </p>
                <br>
                <small>
        ...
        <div class="relative">
            ...
            <div class="absolute w-full ml-20 z-30">
                <div class="shape-bottom">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            ...
            <div class="absolute w-full ml-40 z-10">
                <div class="shape-bottom">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">

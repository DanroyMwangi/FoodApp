...
<body>
    ...
    <div class="main flex flex-row mt-36">
        <div class="w-1/4 relative p-10">
            <form action="#">
                <h4>Packages</h4>
                <div class="product-section bg-white">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="offers" id="unisex">
                ...
                <div class="product-section">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="coat">
                        <label class="form-check-label" for="coat">
                            <small class="text-muted">
                                Beef Eater
                            </small>
                        </label>
                ...
                <div>
                    <div class="minprice">
                        ...
                        <input type="range" id="minprice" value="0" name="minpriceRange" onchange="RangeDisplay()" min="0" max="400">
                        <br>
                        <small id="rangemindisplay"></small>
                    </div>
                    <div class="maxprice">
                        <label for="maxprice">Maximum Price</label>
                        <input type="range" id="maxprice" value="0" name="maxpriceRange" onchange="RangeDisplay()" min="401" max="5000">
                        <br>
                        <small id="rangemaxdisplay"></small>
                    </div>
                </div>
                <hr>
                <div>
                    <button type="submit" class="btn bg-red-700 text-white w-full">
                        Filter
                    </button>
                </div>
            </form>
                    ...
                    <?php foreach($products->fetchAll() as $product):  ?>
                        ...
                        <div class="card-body">
                            ...
                            <form action="cart.php" method="POST">
                                ...
                                <div class="cd-body-footer items-center flex flex-row justify-between m-2">
                                        <div class="w-1/2">
                                            <input type="number" name="productQuantity" min="1" id="productQuantity" placeholder="Quantity" required class="p-2 border-2 w-full rounded border focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                                        </div>
                                        <div class="buy-btn w-1/2">
                                                <button class="btn btn-buy bg-red-700 text-white m-2 w-full" name="orderBtn">
                                                    Order
                                                </button>
                                        </div>
                                </div>
    ...
    <div class="w-full">
        <div class="bg-white text-black w-min flex flex-row border-white border-2 rounded-full btn-container">
            <div>
